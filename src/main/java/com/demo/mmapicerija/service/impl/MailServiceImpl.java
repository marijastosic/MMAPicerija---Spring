...
public class MailServiceImpl implements MailService {
	...
	public void posaljiMailZaRegistraciju(Korisnik korisnik) {
		...
		String postovani = korisnik.getPol().equals("Muški") ? "Poštovani "
				: korisnik.getPol().equals("Ženski") ? "Poštovana " : "Poštovani/a ";
		message.setText(
				postovani + korisnik.getIme() + ",\n\nUspešno ste izvršili registraciju! Vaše korisničko ime je: "
