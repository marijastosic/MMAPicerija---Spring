...
<footer class="page-footer font-small blue pt-4 mt-4"
	style="background-color: #505256; opacity: 0.75; color: white;">

	<div class="container-fluid text-center">

		<h5 class="text-uppercase">MMA Piceriju mozete pratiti putem
			linkova:</h5>
	...
	<div class="footer-copyright text-center py-3"
		style="background-color: #222; color: whitesmoke;">
		© 2018 MMA Picerija: <a href="<c:url value="/"/>"> MMAPicerija.com</a>
	</div>
