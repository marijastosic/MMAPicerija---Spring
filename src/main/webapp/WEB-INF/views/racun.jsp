...
<div class="container">
	<form:form action="${pageContext.request.contextPath}/kupovina"
		method="post" modelAttribute="korisnik">
		
		<form:input path="telefon" id="telefon" value="${korisnik.telefon}" style="display: none;"/>
		<form:input path="adresa" id="adresa" value="${korisnik.adresa}" style="display: none;"/>
		...
		<div
			...
			<div class="row">
				<div class="col-xs-6 col-sm-6 col-md-6">
					<address>
						...
						${korisnik.ime} ${korisnik.prezime} <br> ${korisnik.telefon}
						<br> ${korisnik.adresa}
					</address>
				</div>
			...
			<div class="row">
				<input style="float: right;" type="submit"
					value="Potvrdi porudžbinu" class="btn btn-default" /> <a
					style="float: left;" href="<c:url value="/" />"
